using CallCentre.Data.Mappings.Mappings;
...
{
    public static class CallCentreDataModel
    {
        ...
        private static IList<IBaseModelMapper> RegisterMappers()
        {
            ...
            {
                new UserMapping(),
                new UserLoginHistoryMapping(),
                new CostingTimeSlotMapping(),
                new CalleeMapping(),
                new CalleeCallDurationMapping()
            };
        }
    }
}
